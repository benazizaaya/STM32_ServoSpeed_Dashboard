...
/* USER CODE BEGIN PV */
char lcd_buffer[16]; // To store the speed display string
uint32_t start_time, end_time;
uint32_t prev_time = 0;
uint32_t current_time = 0;
float servo_speed_up = 0;  // Speed during upward motion
float servo_speed_down = 0;  // Speed during downward motion
int total_range = 5200 - 1000; // Différence totale de position

int delay_time = 100; // Délai ajusté (plus grand pour plus de précision)
/* USER CODE END PV */
